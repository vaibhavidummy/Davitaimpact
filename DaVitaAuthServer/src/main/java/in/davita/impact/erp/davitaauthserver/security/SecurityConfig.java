...
import in.davita.impact.erp.davitaauthserver.service.CustomUserDetailService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        web.ignoring().antMatchers("/api/admin-service/registration/");
        web.ignoring().antMatchers("/api/admin-service/authentication/forgotpassword");
    }
